...
function attachEventHandlers() {
    ...
    selectCities.forEach((selectCity) => {
        selectCity.addEventListener("change", function () {
            ...
            selectDistrict.innerHTML = '<option value="" selected>Chọn Quận/huyện</option>';
            selectWard.innerHTML = '<option value="" selected>Chọn Xã/phường/thị trấn</option>';
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    savedAddress.forEach((addressHtml) => {
        document.getElementById("displayAddress").insertAdjacentHTML("beforeend", addressHtml);
    });
    // nhấn thêm địa chỉ
    ...
    if (addAddress) {
        addAddress.addEventListener("click", function (event) {
            ...
            document.getElementById("displayAddress").insertAdjacentHTML("beforeend", newAddressHtml);

            //tải dữ liệu cho trường thành phố vừa thêm
            const newSelectCity = document.querySelector("#displayAddress .row:last-child .floatingcity");
    ...
    if (displayAddress) {
        displayAddress.addEventListener("click", function (event) {
            // event Delegation
