...
public class VoucherPage {
    ...
    public static void InsertVoucherSuccess(String idVoucher, String nameVoucher, String dataDisscountVoucher,
            String maxVoucher, String quality, String minVoucher, String qualityUses, String typeVoucher,
            String yearStart, String monthStart, String dayStart, String yearEnd, String monthEnd, String dayEnd,
            String status, String descriptionn) {
        try {
    ...
    public static void filterVoucherByType(String typeVoucher) {
        ...
        String xpathChoiceType = "//div[@class='col-lg-3 col-md-12 mb-3 mb-lg-0']//select[@name='type']//option[text()='"
                + typeVoucher + "']";
        String btnFilter = "//button[text()='Lọc']";
    ...
    public static WebElement[] selectDay(String year, String month, String day) {
        ...
        // test
        WebElement selectDay = null;
        try {
            selectDay = WaitFor.waitElementVisible(BaseSetup.driver, By.xpath(xpathDay));
            selectDay.click();
        } catch (StaleElementReferenceException e) {
            selectDay = WaitFor.waitElementVisible(BaseSetup.driver, By.xpath(xpathDay)); // Tìm lại phần tử
            selectDay.click();
        }
    ...
    public static void checkTypeVoucher(String typeVouc) {
        ...
        WaitFor.waitElementClick(BaseSetup.driver, By.xpath(xpathType));
