...
public class AccountAdminTest extends BaseTest {
    ...
    public void testAddAccountSuccess() {
        ...
        accountAdminPage.fillAccountForm("hahan33", "hahan33", "hahan33@example.com", "ROLE_USER");
    ...
    //     Assert.assertEquals(actualResultIsEmptyEmail, "[Vui lòng nhập địa chỉ email!]",
    //             "Ket qua mong doi va ket qua thuc te khong giong nhau");
    ...
    //     WebElement actualResult = BaseSetup.driver.findElement(By.xpath(notification));
    //     String actualResultIsEmptyEmail = actualResult.getText();
    //     Assert.assertEquals(actualResultIsEmptyEmail, "[Địa chỉ email không hợp lệ!]",
    //             "Ket qua mong doi va ket qua thuc te khong giong nhau");
    // }
